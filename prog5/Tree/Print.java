...
public class Print {
  ...
  public Print(java.io.PrintWriter o, Temp.TempMap t) {out=o; tmap=t;}

  public Print(java.io.PrintWriter o) {out=o; tmap=new Temp.DefaultMap();}
  ...
  public void prExp(Exp e) {prExp(e,0); sayln("");}
